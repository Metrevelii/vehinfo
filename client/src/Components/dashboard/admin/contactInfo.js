            ...
            <div className="w-full h-[500px] flex justify-start items-center">
                <div className="w-full lg:w-[600px] xl:w-[600px] 2xl:w-[600px] h-[450px] rounded-lg border border-gray-300 flex flex-col">
                    ...
                    <div className="w-full h-[87%]">
                        ...
                        {loading && <p className="font-interMedium font-700 text-primary-black text-[20px]">Loading...</p>}
                        ...
                        {contacts.map((contact) => (
                            <div key={contact._id} className="w-full border-t border-b border-gray-300 flex flex-col p-2 relative">
                                <button onClick={() => handleDelete(contact._id)} className="absolute top-[10px] right-[10px] z-10 py-[3px] px-[5px] h-auto font-interRegular text-[14px] rounded-[4px] bg-primary-white hover:bg-primary-orange text-primary-orange hover:text-primary-white border border-primary-orange cursor-pointer">DELETE</button>
                                <div className="flex w-full items-center mt-2">
                                    <div className="font-interMedium font-bold text-primary-orange text-[13px]">{contact.name}</div>
                                    <div className="font-interMedium font-bold text-primary-orange text-[13px] ml-[7px]">{contact.surname}</div>
                                </div>
